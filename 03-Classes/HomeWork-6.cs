...
partial class Program
{
    static void ShowEmployeesInformation()
    {
        ...
        WriteLine("----- Información de Empleados -----");
...
class Employee
{
    ...
    public void ShowInfo()
    {
        ...
        WriteLine($"Cargo: {Position}");
        WriteLine($"Salario: {Salary}");
        WriteLine($"Bono calculado: {CalculateBonus():C}");
        WriteLine("---------------------------");
    }
}
